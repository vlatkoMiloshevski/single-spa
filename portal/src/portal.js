...
async function init() {
    ...
    // app1: The URL "/app1/..." is being redirected to "http://localhost:9006/..." this is done by the webpack proxy (webpack.config.js)
    ...
    loadingPromises.push(loadApp('appngrx', '/appngrx', '/appngrx/main.js', '/appngrx/store.js', globalEventDistributor));
