        ...
        this.movieList = [
            {
                ...
                'name': 'House Of Cards',
                'checked': false,
                'coverUrl': `https://vignette.wikia.nocookie.net/house-of-card
            s/images/b/b6/House_of_Cards_main_characters.jpg/revision/latest/scale-to-width-down/640?cb=20130818190052`
            },
            {
                'id': 2,
                'name': 'Breaking Bad',
            ...
            },
            {
                ...
                'name': 'Black Mirror',
                'checked': false,
                'coverUrl': `https://i0.wp.com/www.politeonsociety.com/wp-cont
            ent/uploads/2016/10/14670838_10210376146376113_5805593373952688605_n.jpg`
            },
            {
                'id': 4,
